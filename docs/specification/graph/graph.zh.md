...
在不同的视角和布局下，关系图会表现出不一样的模式和行为，呈现出的内容重点也不尽相同。<br />![不同视角 & 布局.jpg](https://gw.alipayobjects.com/mdn/rms_a8a5bf/afts/img/A*ZfKASZGVGZ0AAAAAAAAAAAAAARQnAQ)<br />
...
图分析产品往往是非常重交互的场景，通常用户会在画布执行连续分析的动作或通过一连串的分析行为才拿到有效的结果信息，为了确保用户不错过有效的信息以及防止错误的操作，如误删了某些节点或边或扩展了太多节点，产品中需要提供操作可逆的机制，能够允许用户回退或重复上一步操作。<br />![操作可逆.jpg](https://gw.alipayobjects.com/mdn/rms_a8a5bf/afts/img/A*0ImmTohMsR0AAAAAAAAAAAAAARQnAQ)<br />
