...
![✏️ 常见业务场景.jpg](https://gw.alipayobjects.com/mdn/rms_a8a5bf/afts/img/A*e_umQ7Z2tZMAAAAAAAAAAAAAARQnAQ)
...
![模板类型.png](https://gw.alipayobjects.com/mdn/rms_a8a5bf/afts/img/A*6WImQI7YencAAAAAAAAAAAAAARQnAQ)
...
| **表现层** | 视觉感知层：产品基础界面和图本身节点和边的视觉设计| | **框架层** | 界面布局：如画布、各类组件的布局关系和使用逻辑 | | **结构层** | 流程、信息架构：确定产品中多个图分析模式如何整合为一体，各种功能的模块组合，信息框架的构建 | | **范围层** | 功能/内容需求：定义产品图分析功能和呈现内容的边界 | | **战略层** | 用户需求，业务目标，产品目标 |
...
![有目的.jpg](https://gw.alipayobjects.com/mdn/rms_a8a5bf/afts/img/A*LMdVTLYjINQAAAAAAAAAAAAAARQnAQ)

### 2.2.2 无明确目的

无明确目的地探索是指基于已有数据内容，进行关系的 N 度扩展、下钻分析、子图探索、撤销回退等操作，来挖掘数据中的特性，发现价值或机会点的分析过程。

![无目的.jpg](https://gw.alipayobjects.com/mdn/rms_a8a5bf/afts/img/A*lZ48ToG99w0AAAAAAAAAAAAAARQnAQ)
...
![担保圈.jpg](https://gw.alipayobjects.com/mdn/rms_a8a5bf/afts/img/A*OtCISJXR4Y0AAAAAAAAAAAAAARQnAQ)

#### 2.2.3.b 结合时间或地理信息的场景

在源数据中含有时间和地理维度的内容时，会出现结合时间或地理信息的分析场景。

![地理+时间信息.jpg](https://gw.alipayobjects.com/mdn/rms_a8a5bf/afts/img/A*zeSxT5BccAwAAAAAAAAAAAAAARQnAQ)
...
![image.png](https://gw.alipayobjects.com/mdn/rms_a8a5bf/afts/img/A*J9YNRLoJIVAAAAAAAAAAAAAAARQnAQ)
...
![基础样式.jpg](https://gw.alipayobjects.com/mdn/rms_a8a5bf/afts/img/A*7PnPRZjmVhoAAAAAAAAAAAAAARQnAQ)

无论节点还是边，在设计时，都需要考虑在不同鼠标事件的情况下的视觉表现：

![节状态.jpg](https://gw.alipayobjects.com/mdn/rms_a8a5bf/afts/img/A*vCCSRptzEfoAAAAAAAAAAAAAARQnAQ)

![节点状态.jpg](https://gw.alipayobjects.com/mdn/rms_a8a5bf/afts/img/A*NjA5SqohyDEAAAAAAAAAAAAAARQnAQ)
...
![颜色.jpg](https://gw.alipayobjects.com/mdn/rms_a8a5bf/afts/img/A*bP81Q4EnsfQAAAAAAAAAAAAAARQnAQ)

![色板.jpg](https://gw.alipayobjects.com/mdn/rms_a8a5bf/afts/img/A*Mn-GTJAk6vAAAAAAAAAAAAAAARQnAQ)

同时，我们还提供深、浅色两套主题样式，以满足不同的应用场景：

![深色浅色.jpg](https://gw.alipayobjects.com/mdn/rms_a8a5bf/afts/img/A*NGxnS42PBzcAAAAAAAAAAAAAARQnAQ)
...
![不同视角 & 布局.jpg](https://gw.alipayobjects.com/mdn/rms_a8a5bf/afts/img/A*ZfKASZGVGZ0AAAAAAAAAAAAAARQnAQ) ![不同布局.jpg](https://gw.alipayobjects.com/mdn/rms_a8a5bf/afts/img/A*ZOApQ5CckFsAAAAAAAAAAAAAARQnAQ)
