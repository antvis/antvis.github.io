        ...
        <Article className={style.markdown}>
          ...
          >
            <div className={style.content}>
              ...
              <Form
                onFinish={onFinish}
                {...(windowSize.innerWidth < 960 ? {} : formItemLayout)}
              >
                ...
                <div style={{ textAlign: 'center' }}>
                  <p style={{ color: '#a1a1a1' }}>
                    {lang === 'zh'
                      ? 'issue正文内容,请点击下方按钮跳转到 Github 页面填写'
                      : 'Please click the button below to be redirected to the GitHub page where you can fill in the content for the main issue'}
                  </p>
                  <Button htmlType="submit" type="primary">
                    {lang === 'zh' ? '前往GitHub创建issue' : 'create issue'}
                  </Button>
                </div>
              </Form>
            </div>
