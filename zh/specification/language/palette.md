...
AntV 色板是基于 <a href='https://ant.design/docs/spec/colors-cn' target='_blank'>Ant Design 色彩体系</a>，并结合数据可视化设计价值观而设计。在可视化设计中，色板的运用原则上优先保障给予用户的信任感，同时考虑在呈现阅读、交互反馈强化给到用户轻松感，最重要的是颜色在不同场景中使用的意义感，帮助用户能在数据可视化中启发理解和获取洞见，收获工作的意义。<a href='/zh/specification/resources/' target='_blank'>下载资源色板</a>
...
[Interactive content](<https://antv.antgroup.com/zh/specification/language/palette/>)
